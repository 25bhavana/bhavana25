...
def build_model(input_data):
    ...
    load_model = pickle.load(open('cancer_model_new.pkl','rb'))
    ...
    ic50nm_output = pd.Series(ic50, name='IC50 (microM)')
    
    df = pd.concat([molecule_name, prediction_output, ic50nm_output], axis=1)
    st.write(df)
